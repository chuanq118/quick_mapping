...
public class RouterConfig {
    ...
    @Autowired
    public RouterConfig(IndexHandler indexHandler, LoginHandler loginHandler, ResourceHandler resourceHandler, SystemController systemController, UploadController uploadController) {
    ...
    public RouterFunction<ServerResponse> routes() {
        ...
        return RouterFunctions.route()
                ...
                // 创建新资源
                .POST("/mapping/resource/create", RequestPredicates.accept(MediaType.APPLICATION_JSON), resourceHandler::createResource)
                // 上传接口
